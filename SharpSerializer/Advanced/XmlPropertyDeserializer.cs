...
using Com.EnjoyCodes.SharpSerializer.Core.Xml;

namespace Com.EnjoyCodes.SharpSerializer.Advanced
{
    /// <summary>
    ...
    public sealed class XmlPropertyDeserializer : IPropertyDeserializer
    {
        ...
        {
            // ElementType
            property.ElementType = property.Type != null ? Com.EnjoyCodes.SharpSerializer.Serializing.TypeInfo.GetTypeInfo(property.Type).ElementType : null;
        ...
        private void parseDictionaryProperty(DictionaryProperty property)
        {
            ...
            {
                var typeInfo = Com.EnjoyCodes.SharpSerializer.Serializing.TypeInfo.GetTypeInfo(property.Type);
